...
from scripts.briefing_lib import is_duplicate, is_korean_nonworking_day, jandi_payload, validate_briefing

def story(**changes):
    data = {"title":"AI 온실 제어", "shortTitle":"AI 온실", "date":"2026-09-23", "country":"KR", "category":"스마트팜", "sourceName":"공식기관", "sourceUrl":"https://example.com/news", "imageUrl":"", "summary":"요약", "whyItMatters":"의미", "background":"배경", "technology":"기술", "marketOutlook":"전망", "businessOpportunity":"기회", "actionPoint":"실행", "keywords":["AI"]}
...
def test_jandi_payload_is_short_and_uses_deployed_date_route():
